...
//    NSMutableArray<AVAudioMixInputParameters *> *inputParameters = [NSMutableArray array];
//    AVAssetTrack *bgmTrack = bgmTracks.firstObject;
//    AVMutableAudioMixInputParameters *inputParameter = [AVMutableAudioMixInputParameters audioMixInputParametersWithTrack:bgmTrack];
